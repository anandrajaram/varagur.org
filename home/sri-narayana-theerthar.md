...
description: "Sri Narayana Theerthar (Narayana Tirtha) was a 17th–18th-century saint-composer who composed the Krishna Leela Tharangini in Sanskrit. He attained Deva Mukthi at Varagur after receiving Viswaroopa Darshan of Sri Venkatesa Perumal."
image: /assets/images/home__sri-narayana-theerthar/narayana-theerthar.JPG
schema_type: Person
schema:
  birth_place: "Kaza (Villathur), Guntur district, Andhra Pradesh, India"
  birth_date: "1675"
  death_place: "Varagur, Thanjavur district, Tamil Nadu, India"
  death_date: "1745"
  known_for: "Krishna Leela Tharangini"
  nationality: "Indian"
faq_key: saint
quick_facts:
  - label: Born
    value: "1675 CE, Kaza (Villathur), Guntur district, Andhra Pradesh"
  - label: Original name
    value: "Govinda Shastri"
  - label: Guru
    value: "Sri Shivaramateertha"
  - label: Mukti
    value: "1745 CE, at Varagur"
  - label: Tradition
    value: "Advaita Sannyasi"
  - label: Known for
    value: "Krishna Leela Tharangini (12 tarangams, in Sanskrit)"
  - label: Connection to Varagur
    value: "Received Viswaroopa Darshan and attained Deva Mukthi at Sri Venkatesa Perumal Kovil"
---

<img src="{{ '/assets/images/home__sri-narayana-theerthar/narayana-theerthar.JPG' | relative_url }}" alt="Sri Narayana Theerthar with deities — temple mural" />
...
He is also said to have begun the practice of celebrating Krishna Astami at Varagur as a community festival. That observance is the [Uriyadi festival](/uriyadi/), which has been kept continuously for nearly three centuries.

<figure style="max-width: 380px; margin: 1.5rem auto;">
  <img src="{{ '/assets/images/home__sri-narayana-theerthar/narayana-theerthar-2.JPG' | relative_url }}" alt="Portrait of Sri Narayana Theerthar" />
...
If you have records, photographs, or family memories of Sri Narayana Theerthar that should be added here, please [get in touch](/about/contact/).
